...
```
### Memorable Quotes {.tabset .tabset-pills}
```{r results='asis'}
cat(readLines('Quotes2023.txt'), sep = '\n')
```
...
### Memorable Quotes {.tabset .tabset-pills}
```{r results='asis'}
cat(readLines('Quotes2022.txt'), sep = '\n')
```
...
### Memorable Quotes {.tabset .tabset-pills}
```{r results='asis'}
cat(readLines('Quotes2021.txt'), sep = '\n')
```
...
### Memorable Quotes {.tabset .tabset-pills}
```{r results='asis'}
cat(readLines('Quotes2020.txt'), sep = '\n')
```
