...
booklist<-select(filter(books, Order >=2020 & Order < 2023),c(Title:Genre))


oldbooks<-select(filter(books, Order <2020 & Order >2015),c(Title:Genre))

unread <- books[str_detect(books$Order,"U"),] %>% select(c(Title:Genre))
